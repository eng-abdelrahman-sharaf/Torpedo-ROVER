"use strict";
!function n(r, s, o) { function a(t, e) { if (!s[t]) {
    if (!r[t]) {
    ...
    i = s[t] = { exports: {} }, r[t][0].call(i.exports, function (e) { return a(r[t][1][e] || e); }, i, i.exports, n, r, s, o);
} return s[t].exports; } for (var c = "function" == typeof require && require, e = 0; e < o.length; e++)
    a(o[e]); return a; }({ 1: [function (e, i, t) { !function (e, A) {
            "use strict";
            var U = Math.pow(2, -24), r = Math.pow(2, 32), v = Math.pow(2, 53);
            var t = { encode: function (e) { var o, a = new ArrayBuffer(256), c = new DataView(a), l = 0; function u(e) { for (var t = a.byteLength, i = l + e; t < i;)
                    t *= 2; if (t !== a.byteLength)
                    for (var n = c, r = (a = new ArrayBuffer(t), c = new DataView(a), l + 3 >> 2), s = 0; s < r; ++s)
                        c.setUint32(4 * s, n.getUint32(4 * s)); return o = e, c; } function h() { l += o; } function f(e) { h(u(1).setUint8(l, e)); } function p(e) { for (var t = u(e.length), i = 0; i < e.length; ++i)
                    t.setUint8(l + i, e[i]); h(); } function m(e, t) { var i, n; t < 24 ? f(e << 5 | t) : t < 256 ? (f(e << 5 | 24), f(t)) : t < 65536 ? (f(e << 5 | 25), n = t, h(u(2).setUint16(l, n))) : t < 4294967296 ? (f(e << 5 | 26), n = t, h(u(4).setUint32(l, n))) : (f(e << 5 | 27), e = ((e = t) - (t = t % r)) / r, (i = u(8)).setUint32(l, e), i.setUint32(l + 4, t), h()); } if (!function e(t) { var i; if (!1 === t)
                    return f(244); if (!0 === t)
                    return f(245); if (null === t)
                    return f(246); if (t === A)
                    return f(247); switch (typeof t) {
                    case "number":
                        if (Math.floor(t) === t) {
                            if (0 <= t && t <= v)
                                return m(0, t);
                    ...
                    case "string":
                        for (var n = [], r = 0; r < t.length; ++r) {
                            ...
                            s < 128 ? n.push(s) : (s < 2048 ? n.push(192 | s >> 6) : (s < 55296 ? n.push(224 | s >> 12) : (s = (1023 & s) << 10, s |= 1023 & t.charCodeAt(++r), n.push(240 | (s += 65536) >> 18), n.push(128 | s >> 12 & 63)), n.push(128 | s >> 6 & 63)), n.push(128 | 63 & s));
                        }
                        return m(3, n.length), p(n);
                    default: if (Array.isArray(t))
                        for (m(4, o = t.length), r = 0; r < o; ++r)
                            e(t[r]);
                    ...
                    return a.slice(0, l); for (var e = new ArrayBuffer(l), t = new DataView(e), i = 0; i < l; ++i)
                    t.setUint8(i, c.getUint8(i)); return e; }, decode: function (t, d, y) { var g = new DataView(t), b = 0; function w(e, t) { return b += t, e; } function _(e) { return w(new Uint8Array(t, b, e), e); } function T() { return w(g.getUint8(b), 1); } function x() { return w(g.getUint16(b), 2); } function i() { return w(g.getUint32(b), 4); } function k() { return 255 === g.getUint8(b) && (b += 1, 1); } function L(e) { if (e < 24)
                    return e; if (24 === e)
                    return T(); if (25 === e)
                    return x(); if (26 === e)
                    return i(); if (27 === e)
                    return i() * r + i(); if (31 === e)
                    return -1; throw "Invalid length encoding"; } function S(e) { var t = T(); if (255 === t)
                    return -1; var i = L(31 & t); if (i < 0 || t >> 5 !== e)
                    throw "Invalid indefinite length element"; return i; } function M(e, t) { for (var i = 0; i < t; ++i) {
                    var n = T();
                    128 & n && (n < 224 ? (n = (31 & n) << 6 | 63 & T(), --t) : n < 240 ? (n = (15 & n) << 12 | (63 & T()) << 6 | 63 & T(), t -= 2) : (n = (15 & n) << 18 | (63 & T()) << 12 | (63 & T()) << 6 | 63 & T(), t -= 3)), n < 65536 ? e.push(n) : (n -= 65536, e.push(55296 | n >> 10), e.push(56320 | 1023 & n));
                } } "function" != typeof d && (d = function (e) { return e; }), "function" != typeof y && (y = function () { return A; }); var e = function e() { var t, i, n = T(), r = n >> 5, n = 31 & n; if (7 == r)
                    switch (n) {
                        case 25:
                            var s = new ArrayBuffer(4), s = new DataView(s), o = x(), a = 31744 & o, c = 1023 & o;
                            if (31744 === a)
                                a = 261120;
                            else if (0 !== a)
                                a += 114688;
                                ...
                                return c * U;
                            return s.setUint32(0, (32768 & o) << 16 | a << 13 | c << 13), s.getFloat32(0);
                        case 26: return w(g.getFloat32(b), 4);
                        case 27: return w(g.getFloat64(b), 8);
                    } if ((t = L(n)) < 0 && (r < 2 || 6 < r))
                    throw "Invalid length"; switch (r) {
                    case 0: return t;
                    case 1: return -1 - t;
                    case 2:
                        if (t < 0) {
                            for (var l = [], u = 0; 0 <= (t = S(r));)
                                u += t, l.push(_(t));
                            for (var h = new Uint8Array(u), f = 0, p = 0; p < l.length; ++p)
                    ...
                    throw "Remaining bytes"; return e; } };
            "function" == typeof define && define.amd ? define("cbor/cbor", t) : void 0 !== i && i.exports ? i.exports = t : e.CBOR || (e.CBOR = t);
        }(this); }, {}], 2: [function (e, U, E) { !function (M, A) { !function () { function h() { this._events = {}, this._conf && t.call(this, this._conf); } function t(e) { e && ((this._conf = e).delimiter && (this.delimiter = e.delimiter), e.maxListeners !== g && (this._maxListeners = e.maxListeners), e.wildcard && (this.wildcard = e.wildcard), e.newListener && (this._newListener = e.newListener), e.removeListener && (this._removeListener = e.removeListener), e.verboseMemoryLeak && (this.verboseMemoryLeak = e.verboseMemoryLeak), e.ignoreErrors && (this.ignoreErrors = e.ignoreErrors), this.wildcard) && (this.listenerTree = {}); } function f(e, t) { var i = "(node) warning: possible EventEmitter memory leak detected. " + e + " listeners added. Use emitter.setMaxListeners() to increase limit."; this.verboseMemoryLeak && (i += " Event name: " + t + "."), void 0 !== M && M.emitWarning ? ((t = new Error(i)).name = "MaxListenersExceededWarning", t.emitter = this, t.count = e, M.emitWarning(t)) : (console.error(i), console.trace && console.trace()); } function l(e, t, i) { var n = arguments.length; switch (n) {
            case 0: return [];
            case 1: return [e];
            case 2: return [e, t];
            case 3: return [e, t, i];
            default:
                for (var r = new Array(n); n--;)
                    r[n] = arguments[n];
                return r;
        } } function i(e, t) { for (var i = {}, n = e.length, r = t ? t.length : 0, s = 0; s < n; s++)
            i[e[s]] = s < r ? t[s] : g; return i; } function p(e, t, i) { var n, r; if (this._emitter = e, this._target = t, this._listeners = {}, this._listenersCount = 0, (i.on || i.off) && (n = i.on, r = i.off), t.addEventListener ? (n = t.addEventListener, r = t.removeEventListener) : t.addListener ? (n = t.addListener, r = t.removeListener) : t.on && (n = t.on, r = t.off), !n && !r)
            throw Error("target does not implement any known event API"); if ("function" != typeof n)
            throw TypeError("on method must be a function"); if ("function" != typeof r)
            throw TypeError("off method must be a function"); this._on = n, this._off = r; i = e._observers; i ? i.push(this) : e._observers = [this]; } function m(e, t, i, n) { var r = Object.assign({}, t); if (e) {
            if ("object" != typeof e)
                throw TypeError("options must be an object");
            for (var s, o, a, c = Object.keys(e), l = c.length, u = 0; u < l; u++) {
                if (s = c[u], !n && !b.call(t, s))
                    throw Error('Unknown "' + s + '" option');
                (o = e[s]) !== g && (a = i[s], r[s] = a ? a(o, h) : o);
            }
        } return r; function h(e) { throw Error('Invalid "' + s + '" option value' + (e ? ". Reason: " + e : "")); } } function n(e, t) { return "function" == typeof e && e.hasOwnProperty("prototype") || t("value must be a constructor"), e; } function e(r) { var s = "value must be type of " + r.join("|"), o = r.length, n = r[0], a = r[1]; return 1 === o ? function (e, t) { if (typeof e === n)
            return e; t(s); } : 2 === o ? function (e, t) { var i = typeof e; if (i === n || i === a)
            return e; t(s); } : function (e, t) { for (var i = typeof e, n = o; 0 < n--;)
            if (i === r[n])
                return e; t(s); }; } function c(o, a, c) { var l, u, h, f = 0, p = new o(function (t, i, e) { function n() { u = u && null, f && (clearTimeout(f), f = 0); } c = m(c, { timeout: 0, overload: !1 }, { timeout: function (e, t) { return ("number" != typeof (e *= 1) || e < 0 || !Number.isFinite(e)) && t("timeout must be a positive number"), e; } }), l = !c.overload && "function" == typeof o.prototype.cancel && "function" == typeof e; function r(e) { n(), t(e); } function s(e) { n(), i(e); } l ? a(r, s, e) : (u = [function (e) { s(e || Error("canceled")); }], a(r, s, function (e) { if (h)
            throw Error("Unable to subscribe on cancel event asynchronously"); if ("function" != typeof e)
            throw TypeError("onCancel callback must be a function"); u.push(e); }), h = !0), 0 < c.timeout && (f = setTimeout(function () { var e = Error("timeout"); e.code = "ETIMEDOUT", f = 0, p.cancel(e), i(e); }, c.timeout)); }); return l || (p.cancel = function (e) { if (u) {
            for (var t = u.length, i = 1; i < t; i++)
                u[i](e);
            u[0](e), u = null;
        } }), p; } function v(e) { var t = this._observers; if (t)
            for (var i = t.length, n = 0; n < i; n++)
                if (t[n]._target === e)
                    return n; return -1; } function _(e, t, i, n, r) { if (!i)
            return null; if (0 === n) {
            var s = typeof t;
            if ("string" == s) {
                var o, a, c = 0, l = 0, u = this.delimiter, h = u.length;
                if (-1 !== (a = t.indexOf(u))) {
                    for (o = new Array(5); o[c++] = t.slice(l, a), -1 !== (a = t.indexOf(u, l = a + h));)
                        ;
                ...
                r = "object" == s ? t.length : (t = [t], 1);
        } var f, p, m, v, d, y, g = null, b = t[n], w = t[n + 1]; if (n === r)
            i._listeners && (g = ("function" == typeof i._listeners ? e && e.push(i._listeners) : e && e.push.apply(e, i._listeners), [i]));
        else {
            if ("*" === b) {
                for (a = (d = L(i)).length; 0 < a--;)
                    "_listeners" !== (f = d[a]) && (y = _(e, t, i[f], n + 1, r)) && (g ? g.push.apply(g, y) : g = y);
                return g;
            }
            if ("**" === b) {
                for ((v = n + 1 === r || n + 2 === r && "*" === w) && i._listeners && (g = _(e, t, i, r, r)), a = (d = L(i)).length; 0 < a--;)
                    "_listeners" !== (f = d[a]) && (y = "*" === f || "**" === f ? (i[f]._listeners && !v && (y = _(e, t, i[f], r, r)) && (g ? g.push.apply(g, y) : g = y), _(e, t, i[f], n, r)) : _(e, t, i[f], f === w ? n + 2 : n, r)) && (g ? g.push.apply(g, y) : g = y);
                return g;
            }
            i[b] && (g = _(e, t, i[b], n + 1, r));
        } if ((s = i["*"]) && _(e, t, s, n + 1, r), p = i["**"])
            if (n < r)
                for (p._listeners && _(e, t, p, r, r), a = (d = L(p)).length; 0 < a--;)
                    "_listeners" !== (f = d[a]) && (f === w ? _(e, t, p[f], n + 2, r) : f === b ? _(e, t, p[f], n + 1, r) : ((m = {})[f] = p[f], _(e, t, { "**": m }, n + 1, r)));
            else
                p._listeners ? _(e, t, p, r, r) : p["*"] && p["*"]._listeners && _(e, t, p["*"], r, r); return g; } function u(e, t, i, n) { for (var r, s, o, a = L(e), c = a.length, l = e._listeners; 0 < c--;)
            r = e[o = a[c]], s = "_listeners" === o ? i : i ? i.concat(o) : [o], o = n || "symbol" == typeof o, l && t.push(o ? s : s.join(this.delimiter)), "object" == typeof r && u.call(this, r, t, s, o); return t; } function d(e) { for (var t, i, n, r = L(e), s = r.length; 0 < s--;)
            (t = e[i = r[s]]) && (n = !0, "_listeners" === i || d(t) || delete e[i]); return n; } function y(e, t, i) { this.emitter = e, this.event = t, this.listener = i; } function r(e) { this._events = {}, this._newListener = !1, this._removeListener = !1, this.verboseMemoryLeak = !1, t.call(this, e); } var g, b, w, T, x, s, k, L, a, o, S; b = Object.hasOwnProperty, w = Array.isArray || function (e) { return "[object Array]" === Object.prototype.toString.call(e); }, T = "object" == typeof M && "function" == typeof M.nextTick, x = "function" == typeof Symbol, s = "object" == typeof Reflect, k = "function" == typeof A ? A : setTimeout, L = x ? s && "function" == typeof Reflect.ownKeys ? Reflect.ownKeys : function (e) { var t = Object.getOwnPropertyNames(e); return t.push.apply(t, Object.getOwnPropertySymbols(e)), t; } : Object.keys, Object.assign(p.prototype, { subscribe: function (i, n, r) { function t() { var e = l.apply(null, arguments), t = { data: e, name: n, original: i }; r ? !1 !== r.call(o, t) && a.emit.apply(a, [t.name].concat(e)) : a.emit.apply(a, [n].concat(e)); } var s = this, o = this._target, a = this._emitter, c = this._listeners; if (c[i])
                throw Error("Event '" + i + "' is already listening"); this._listenersCount++, a._newListener && a._removeListener && !s._onNewListener ? (this._onNewListener = function (e) { e === n && null === c[i] && (c[i] = t, s._on.call(o, i, t)); }, a.on("newListener", this._onNewListener), this._onRemoveListener = function (e) { e === n && !a.hasListeners(e) && c[i] && (c[i] = null, s._off.call(o, i, t)); }, c[i] = null, a.on("removeListener", this._onRemoveListener)) : (c[i] = t, s._on.call(o, i, t)); }, unsubscribe: function (e) { var t, i, n, r = this, s = this._listeners, o = this._emitter, a = this._off, c = this._target; if (e && "string" != typeof e)
                throw TypeError("event must be a string"); function l() { r._onNewListener && (o.off("newListener", r._onNewListener), o.off("removeListener", r._onRemoveListener), r._onNewListener = null, r._onRemoveListener = null); var e = v.call(o, r); o._observers.splice(e, 1); } if (e)
                (t = s[e]) && (a.call(c, e, t), delete s[e], --this._listenersCount || l());
            else {
                for (n = (i = L(s)).length; 0 < n--;)
                    e = i[n], a.call(c, e, s[e]);
                this._listeners = {}, this._listenersCount = 0, l();
            } } }), a = e(["function"]), o = e(["object", "function"]), y.prototype.off = function () { return this.emitter.off(this.event, this.listener), this; }, (r.EventEmitter2 = r).prototype.listenTo = function (l, e, u) { if ("object" != typeof l)
            throw TypeError("target musts be an object"); var h = this; function t(e) { if ("object" != typeof e)
            throw TypeError("events must be an object"); for (var t, i = u.reducers, n = v.call(h, l), r = -1 === n ? new p(h, l, u) : h._observers[n], s = L(e), o = s.length, a = "function" == typeof i, c = 0; c < o; c++)
            t = s[c], r.subscribe(t, e[t] || t, a ? i : i && i[t]); } return u = m(u, { on: g, off: g, reducers: g }, { on: a, off: a, reducers: o }), w(e) ? t(i(e)) : t("string" == typeof e ? i(e.split(/\s+/)) : e), this; }, r.prototype.stopListeningTo = function (e, t) { var i = this._observers; if (!i)
            return !1; var n, r = i.length, s = !1; if (e && "object" != typeof e)
            throw TypeError("target should be an object"); for (; 0 < r--;)
            n = i[r], e && n._target !== e || (n.unsubscribe(t), s = !0); return s; }, r.prototype.delimiter = ".", r.prototype.setMaxListeners = function (e) { e !== g && (this._maxListeners = e, this._conf || (this._conf = {}), this._conf.maxListeners = e); }, r.prototype.getMaxListeners = function () { return this._maxListeners; }, r.prototype.event = "", r.prototype.once = function (e, t, i) { return this._once(e, t, !1, i); }, r.prototype.prependOnceListener = function (e, t, i) { return this._once(e, t, !0, i); }, r.prototype._once = function (e, t, i, n) { return this._many(e, 1, t, i, n); }, r.prototype.many = function (e, t, i, n) { return this._many(e, t, i, !1, n); }, r.prototype.prependMany = function (e, t, i, n) { return this._many(e, t, i, !0, n); }, r.prototype._many = function (e, t, i, n, r) { var s = this; if ("function" != typeof i)
            throw new Error("many only accepts instances of Function"); function o() { return 0 == --t && s.off(e, o), i.apply(this, arguments); } return o._origin = i, this._on(e, o, n, r); }, r.prototype.emit = function () { if (!this._events && !this._all)
            return !1; this._events || h.call(this); var e, t, i, n, r, s, o = arguments[0], a = this.wildcard; if ("newListener" === o && !this._newListener && !this._events.newListener)
            return !1; if (a && "newListener" !== (e = o) && "removeListener" !== o && "object" == typeof o) {
            if (i = o.length, x)
                for (n = 0; n < i; n++)
            ...
            _.call(this, c = [], e, this.listenerTree, 0, i);
        else {
            ...
            return !!this._all; throw arguments[1] instanceof Error ? arguments[1] : new Error("Uncaught, unspecified 'error' event."); }, r.prototype.emitAsync = function () { if (!this._events && !this._all)
            return !1; this._events || h.call(this); var e, t, i, n, r, s, o = arguments[0], a = this.wildcard; if ("newListener" === o && !this._newListener && !this._events.newListener)
            return Promise.resolve([!1]); if (a && "newListener" !== (e = o) && "removeListener" !== o && "object" == typeof o) {
            if (n = o.length, x)
                for (r = 0; r < n; r++)
        ...
        } var c, l = [], u = arguments.length; if (this._all)
            for (r = 0, n = this._all.length; r < n; r++)
                switch (this.event = o, u) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        l.push(this._all[r].call(this, o, arguments[1], arguments[2]));
                        break;
                    default: l.push(this._all[r].apply(this, arguments));
                } if (a ? _.call(this, c = [], e, this.listenerTree, 0) : c = this._events[o], "function" == typeof c)
            switch (this.event = o, u) {
                case 1:
                    l.push(c.call(this));
                    break;
            ...
            for (r = 0, n = c.length; r < n; r++)
                switch (this.event = o, u) {
                    ...
                    case 3:
                        ...
                        break;
                    default: l.push(c[r].apply(this, i));
                }
        }
        else if (!this.ignoreErrors && !this._all && "error" === o)
            return arguments[1] instanceof Error ? Promise.reject(arguments[1]) : Promise.reject("Uncaught, unspecified 'error' event."); return Promise.all(l); }, r.prototype.on = function (e, t, i) { return this._on(e, t, !1, i); }, r.prototype.prependListener = function (e, t, i) { return this._on(e, t, !0, i); }, r.prototype.onAny = function (e) { return this._onAny(e, !1); }, r.prototype.prependAny = function (e) { return this._onAny(e, !0); }, r.prototype.addListener = r.prototype.on, r.prototype._onAny = function (e, t) { if ("function" != typeof e)
            throw new Error("onAny only accepts instances of Function"); return this._all || (this._all = []), t ? this._all.unshift(e) : this._all.push(e), this; }, r.prototype._on = function (e, t, i, n) { if ("function" == typeof e)
            return this._onAny(e, t), this; if ("function" != typeof t)
            throw new Error("on only accepts instances of Function"); this._events || h.call(this); var r = this; return n !== g && (t = (n = function (e, t, i) { if (!0 === i)
            r = !0;
        else if (!1 === i)
            n = !0;
        else {
            ...
            var n = i.async, r = i.promisify, s = i.nextTick, o = i.objectify;
        } if (n || s || r) {
            var a = t, i = t._origin || t;
            if (s && !T)
                throw Error("process.nextTick is not supported");
            r === g && (r = "AsyncFunction" === t.constructor.name), (t = function () { var e = arguments, t = this, i = this.event; return r ? s ? Promise.resolve() : new Promise(function (e) { k(e); }).then(function () { return t.event = i, a.apply(t, e); }) : (s ? M.nextTick : k)(function () { t.event = i, a.apply(t, e); }); })._async = !0, t._origin = i;
        } return [t, o ? new y(this, e, t) : this]; }.call(this, e, t, n))[0], r = n[1]), this._newListener && this.emit("newListener", e, t), this.wildcard ? function (e, t, i) { var n, r = 0, s = 0, o = this.delimiter, a = o.length; if ("string" == typeof e)
            if (-1 !== (u = e.indexOf(o))) {
                for (n = new Array(5); n[r++] = e.slice(s, u), -1 !== (u = e.indexOf(o, s = u + a));)
                    ;
                n[r++] = e.slice(s);
            }
            else
            ...
            for (u = 0; u + 1 < r; u++)
                if ("**" === n[u] && "**" === n[u + 1])
                    return; for (var c, l = this.listenerTree, u = 0; u < r; u++)
            if (l = l[c = n[u]] || (l[c] = {}), u === r - 1)
                return l._listeners ? ("function" == typeof l._listeners && (l._listeners = [l._listeners]), i ? l._listeners.unshift(t) : l._listeners.push(t), !l._listeners.warned && 0 < this._maxListeners && l._listeners.length > this._maxListeners && (l._listeners.warned = !0, f.call(this, l._listeners.length, c))) : l._listeners = t, !0; return !0; }.call(this, e, t, i) : this._events[e] ? ("function" == typeof this._events[e] && (this._events[e] = [this._events[e]]), i ? this._events[e].unshift(t) : this._events[e].push(t), !this._events[e].warned && 0 < this._maxListeners && this._events[e].length > this._maxListeners && (this._events[e].warned = !0, f.call(this, this._events[e].length, e))) : this._events[e] = t, r; }, r.prototype.off = function (e, t) { if ("function" != typeof t)
            throw new Error("removeListener only takes instances of Function"); var i = []; if (this.wildcard) {
            ...
            var s = i[r], o = s._listeners;
            if (w(o)) {
                for (var a = -1, c = 0, l = o.length; c < l; c++)
                    if (o[c] === t || o[c].listener && o[c].listener === t || o[c]._origin && o[c]._origin === t) {
                        a = c;
                        break;
                    }
                if (!(a < 0))
                    return (this.wildcard ? s._listeners : this._events[e]).splice(a, 1), 0 === o.length && (this.wildcard ? delete s._listeners : delete this._events[e]), this._removeListener && this.emit("removeListener", e, t), this;
            }
            else
                (o === t || o.listener && o.listener === t || o._origin && o._origin === t) && (this.wildcard ? delete s._listeners : delete this._events[e], this._removeListener) && this.emit("removeListener", e, t);
        } return this.listenerTree && d(this.listenerTree), this; }, r.prototype.offAny = function (e) { var t, i = 0, n = 0; if (e && this._all && 0 < this._all.length) {
            for (i = 0, n = (t = this._all).length; i < n; i++)
                if (e === t[i])
                    return t.splice(i, 1), this._removeListener && this.emit("removeListenerAny", e), this;
        }
        else {
            ...
            this._all = [];
        } return this; }, r.prototype.removeListener = r.prototype.off, r.prototype.removeAllListeners = function (e) { if (e === g)
            this._events && h.call(this);
        else if (this.wildcard) {
            var t, i = _.call(this, null, e, this.listenerTree, 0);
            if (!i)
                return this;
            ...
            this._events && (this._events[e] = null); return this; }, r.prototype.listeners = function (e) { var t, i, n, r, s, o, a, c = this._events; if (e !== g)
            return this.wildcard ? (s = this.listenerTree) ? (o = [], a = "string" == typeof e ? e.split(this.delimiter) : e.slice(), _.call(this, o, a, s, 0), o) : [] : c && (i = c[e]) ? "function" == typeof i ? [i] : i : []; if (this.wildcard)
            throw Error("event name required for wildcard emitter"); if (!c)
            return []; for (r = (t = L(c)).length, n = []; 0 < r--;)
            "function" == typeof (i = c[t[r]]) ? n.push(i) : n.push.apply(n, i); return n; }, r.prototype.eventNames = function (e) { var t = this._events; return this.wildcard ? u.call(this, this.listenerTree, [], null, e) : t ? L(t) : []; }, r.prototype.listenerCount = function (e) { return this.listeners(e).length; }, r.prototype.hasListeners = function (e) { var t, i; return this.wildcard ? (i = [], t = "string" == typeof e ? e.split(this.delimiter) : e.slice(), _.call(this, i, t, this.listenerTree, 0), 0 < i.length) : (t = this._events, !!((i = this._all) && i.length || t && (e === g ? L(t).length : t[e]))); }, r.prototype.listenersAny = function () { return this._all || []; }, r.prototype.waitFor = function (r, s) { var o = this, e = typeof s; return "number" == e ? s = { timeout: s } : "function" == e && (s = { filter: s }), c((s = m(s, { timeout: 0, filter: g, handleError: !1, Promise: Promise, overload: !1 }, { filter: a, Promise: n })).Promise, function (t, i, e) { function n() { var e = s.filter; e && !e.apply(o, arguments) || (o.off(r, n), s.handleError ? (e = arguments[0]) ? i(e) : t(l.apply(null, arguments).slice(1)) : t(l.apply(null, arguments))); } e(function () { o.off(r, n); }), o._on(r, n, !1); }, { timeout: s.timeout, overload: s.overload }); }, S = r.prototype, Object.defineProperties(r, { defaultMaxListeners: { get: function () { return S._maxListeners; }, set: function (e) { if ("number" != typeof e || e < 0 || Number.isNaN(e))
                    throw TypeError("n must be a non-negative number"); S._maxListeners = e; }, enumerable: !0 }, once: { value: function (o, a, e) { return c((e = m(e, { Promise: Promise, timeout: 0, overload: !1 }, { Promise: n })).Promise, function (e, t, i) { var n, r, s; "function" == typeof o.addEventListener ? (n = function () { e(l.apply(null, arguments)); }, i(function () { o.removeEventListener(a, n); }), o.addEventListener(a, n, { once: !0 })) : (r = function () { s && o.removeListener("error", s), e(l.apply(null, arguments)); }, "error" !== a && (s = function (e) { o.removeListener(a, r), t(e); }, o.once("error", s)), i(function () { s && o.removeListener("error", s), o.removeListener(a, r); }), o.once(a, r)); }, { timeout: e.timeout, overload: e.overload }); }, writable: !0, configurable: !0 } }), Object.defineProperties(S, { _maxListeners: { value: 10, writable: !0, configurable: !0 }, _observers: { value: null, writable: !0, configurable: !0 } }), "function" == typeof define && define.amd ? define(function () { return r; }) : "object" == typeof E ? U.exports = r : new Function("", "return this")().EventEmitter2 = r; }.call(this); }.call(this, e("_process"), e("timers").setImmediate); }, { _process: 4, timers: 5 }], 3: [function (e, t, i) {
            "use strict";
            ...
            t.exports = function () { try {
                if (Object.assign) {
                    ...
                    if (e[5] = "de", "5" !== Object.getOwnPropertyNames(e)[0]) {
                        ...
                        var n, r = Object.getOwnPropertyNames(t).map(function (e) { return t[e]; });
                        if ("0123456789" === r.join(""))
                            return n = {}, "abcdefghijklmnopqrst".split("").forEach(function (e) { n[e] = e; }), "abcdefghijklmnopqrst" === Object.keys(Object.assign({}, n)).join("") ? 1 : void 0;
                    }
                }
            }
            catch (e) { } }() ? Object.assign : function (e, t) { for (var i, n = function (e) { if (null == e)
                throw new TypeError("Object.assign cannot be called with null or undefined"); return Object(e); }(e), r = 1; r < arguments.length; r++) {
        ...
        }, {}], 4: [function (e, t, i) { var n, r, t = t.exports = {}; function s() { throw new Error("setTimeout has not been defined"); } function o() { throw new Error("clearTimeout has not been defined"); } try {
        ...
        } } var c, l = [], u = !1, h = -1; function f() { u && c && (u = !1, c.length ? l = c.concat(l) : h = -1, l.length) && p(); } function p() { if (!u) {
            for (var e = a(f), t = (u = !0, l.length); t;) {
                for (c = l, l = []; ++h < t;)
                    c && c[h].run();
                h = -1, t = l.length;
            }
            c = null, u = !1, !function (t) { if (r === clearTimeout)
                return clearTimeout(t); if ((r === o || !r) && clearTimeout)
                return (r = clearTimeout)(t); try {
                r(t);
            }
            catch (e) {
                try {
            ...
            if (-1 === o.indexOf("/"))
                ...
                c ? (a = u(c, t), i[s] = -1 === r ? a : [a]) : h.emit("error", "Cannot find " + o + " in decodeTypeDefs");
            }
            ...
            var h = c.nodeName;
            "sphere" === h ? this.geometry = new w({ xml: c }) : "box" === h ? this.geometry = new y({ xml: c }) : "cylinder" === h ? this.geometry = new d({ xml: c }) : "mesh" === h ? this.geometry = new b({ xml: c }) : console.warn("Unknown geometry type " + h);
        } var f = s.getElementsByTagName("material"); 0 < f.length && (this.material = new g({ xml: f[0] })); }; }, { "../math/Pose": 24, "../math/Quaternion": 25, "../math/Vector3": 27, "./UrdfBox": 32, "./UrdfCylinder": 34, "./UrdfMaterial": 37, "./UrdfMesh": 38, "./UrdfSphere": 40 }], 43: [function (e, t, i) { t.exports = e("object-assign")({ UrdfBox: e("./UrdfBox"), UrdfColor: e("./UrdfColor"), UrdfCylinder: e("./UrdfCylinder"), UrdfLink: e("./UrdfLink"), UrdfMaterial: e("./UrdfMaterial"), UrdfMesh: e("./UrdfMesh"), UrdfModel: e("./UrdfModel"), UrdfSphere: e("./UrdfSphere"), UrdfVisual: e("./UrdfVisual") }, e("./UrdfTypes")); }, { "./UrdfBox": 32, "./UrdfColor": 33, "./UrdfCylinder": 34, "./UrdfLink": 36, "./UrdfMaterial": 37, "./UrdfMesh": 38, "./UrdfModel": 39, "./UrdfSphere": 40, "./UrdfTypes": 41, "./UrdfVisual": 42, "object-assign": 3 }], 44: [function (e, t, i) {
            "use strict";
            var u = Math.pow(2, 32), n = !1;
            function h() { n || (n = !0, console.warn("CBOR 64-bit integer array values may lose precision. No further warnings.")); }
            var r = { 64: Uint8Array, 69: Uint16Array, 70: Uint32Array, 72: Int8Array, 77: Int16Array, 78: Int32Array, 85: Float32Array, 86: Float64Array }, s = { 71: function (e) { h(); for (var t = e.byteLength, i = e.byteOffset, n = t / 8, e = e.buffer.slice(i, i + t), r = new Uint32Array(e), s = new Array(n), o = 0; o < n; o++) {
                    var a = 2 * o, c = r[a], a = r[1 + a];
                    s[o] = c + u * a;
                } return s; }, 79: function (e) { h(); for (var t = e.byteLength, i = e.byteOffset, n = t / 8, e = e.buffer.slice(i, i + t), r = new Uint32Array(e), s = new Int32Array(e), o = new Array(n), a = 0; a < n; a++) {
                    var c = 2 * a, l = r[c], c = s[1 + c];
                    o[a] = l + u * c;
                } return o; } };
            void 0 !== t && t.exports && (t.exports = function (e, t) { var i, n; return t in r ? (i = e.byteLength, n = e.byteOffset, new r[t](e.buffer.slice(n, n + i))) : t in s ? s[t](e) : e; });
        }, {}], 45: [function (e, t, i) { i.DOMImplementation = window.DOMImplementation, i.XMLSerializer = window.XMLSerializer, i.DOMParser = window.DOMParser; }, {}], 46: [function (e, t, i) { t.exports = "undefined" != typeof window ? window.WebSocket : WebSocket; }, {}], 47: [function (e, t, i) { t.exports = function () { return document.createElement("canvas"); }; }, {}], 48: [function (e, t, i) {
            "use strict";
            var a = e("canvas"), n = a.Image || window.Image;
            t.exports = function (e, s) { var o = new n; o.onload = function () { for (var e = new a, t = e.getContext("2d"), i = (e.width = o.width, e.height = o.height, t.imageSmoothingEnabled = !1, t.webkitImageSmoothingEnabled = !1, t.mozImageSmoothingEnabled = !1, t.drawImage(o, 0, 0), t.getImageData(0, 0, o.width, o.height).data), n = "", r = 0; r < i.length; r += 4)
                n += String.fromCharCode(i[r], i[r + 1], i[r + 2]); s(JSON.parse(n)); }, o.src = "data:image/png;base64," + e; };
        }, { canvas: 47 }], 49: [function (t, e, i) { try {
            var n = t("webworkify");
        }
        catch (e) {
            n = t("webworkify-webpack");
        } var r = t("./workerSocketImpl"); function s(e) { this.socket_ = n(r), this.socket_.addEventListener("message", this.handleWorkerMessage_.bind(this)), this.socket_.postMessage({ uri: e }); } s.prototype.handleWorkerMessage_ = function (e) { var t = e.data; if (t instanceof ArrayBuffer || "string" == typeof t)
            this.onmessage(e);
        else {
            e = t.type;
            if ("close" === e)
